...
# Debo renderizar primero así: rmarkdown::render("index.Rmd") ...
# ... y luego así: pagedown::chrome_print("index.html").
#
# If needed:
...
<i class="fa fa-mobile-alt"></i> +34 611 768 163

<i class="fas fa-envelope"></i> jollopezma@gmail.com
